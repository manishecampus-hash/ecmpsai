...
export default function CompareSubHeader() {
  ...
  return (
    <div
      className={`sticky top-16 z-40 bg-white border-b border-gray-200 transition-all duration-300 ease-in-out ${isScrolled ? "translate-y-0 opacity-100 shadow-sm" : "-translate-y-full opacity-0 pointer-events-none"}`}
    >
