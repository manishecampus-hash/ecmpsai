      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center font-[Inter]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 text-left">
          {careerExplorer.map((item, index) => (
            <div
              key={index}
              className="group bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-col transition-shadow duration-300 hover:shadow-md"
            >
              ...
              <div className="relative w-full h-[120px] rounded-2xl overflow-hidden bg-gray-100 border border-gray-200 mb-4 shrink-0">
                ...
                <div
                  className="absolute inset-0 flex flex-col justify-center gap-2 p-3
                             bg-[#1b1464]/90 opacity-0 translate-y-1
                             pointer-events-none
                             group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto
                             transition-all duration-300 ease-out"
                >
                  <p className="text-white/90 text-[11px] leading-snug line-clamp-3">
                    {item.description ??
                  ...
                  <button
                    type="button"
                    className="self-start inline-flex items-center gap-1 text-[11px] font-bold text-white
