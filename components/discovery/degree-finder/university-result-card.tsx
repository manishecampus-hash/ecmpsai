...
// aliases used by degree-finder-flow
export const universities = mbaUniversities;

export const getUniversitiesByCourse = (course: string): University[] => {
  return mbaUniversities;
};
