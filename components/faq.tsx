...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. eCampusEdu allows students to compare universities, fees, curriculum, specializations, accreditations, learning formats, and career opportunities to make informed decisions.",
  },
  {
    question:
