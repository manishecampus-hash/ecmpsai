...
const CustomSelectTrigger = ({
  ...
  return (
    <SelectTrigger
      className="relative h-10 bg-white border border-gray-200 text-gray-900 w-full px-3 rounded-xl text-sm cursor-pointer pr-10 [&>svg:last-child]:hidden"
    >
      {children}

      <ChevronDown
        className={`absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-600 pointer-events-none transition-transform duration-200 ${
...
export function BrochureForm({
  ...
  const isFormValid = !!(
    ...
    isPhoneValid() &&
    formData.course &&
    (selectedCountry.code === "in" ? formData.state : true)
  );
  ...
  const handleCountryChange = (code: string) => {
    ...
    if (country) {
      ...
      setFormData({
        ...formData,
        mobile: "",
        state: selectedCountry.code === "in" ? "" : formData.state,
      });
    ...
    <div className="w-full max-w-md mx-auto bg-white rounded-2xl px-4 sm:px-6 py-4 sm:py-6">
      ...
      >
        ...
        <div>
          ...
          >
            <CustomSelectTrigger isOpen={countryOpen}>
            ...
            <SelectContent
              ...
              align="start"
              sideOffset={4}
              className="z-[99999] bg-white border border-gray-200 text-gray-900 max-h-48 overflow-y-auto w-full"
            >
        ...
        <div>
          ...
          >
            <CustomSelectTrigger isOpen={courseOpen}>
            ...
            <SelectContent
              ...
              align="start"
              sideOffset={4}
              className="z-[99999] bg-white border border-gray-200 text-gray-900 max-h-48 w-[var(--radix-select-trigger-width)] overflow-y-auto"
            >
              {courseList.map((c) => (
        ...
        {selectedCountry.code === "in" && (
          <div>
            ...
            >
              <CustomSelectTrigger isOpen={stateOpen}>
        ...
        <Button
          ...
          className="w-full h-10 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold rounded-xl transition-colors mt-1 text-sm flex items-center justify-center gap-2"
        >
          {isSubmitting ? (
