...
export function LandingPagePlacementPartners({
  ...
  return (
    <section
      id="placements"
      className="relative w-full overflow-hidden bg-slate-50/50 border-b border-slate-100 !m-0 !p-0"
    >
      <style>{`
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-16 font-sans sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        <div className="mx-auto max-w-3xl mb-12 sm:mb-14 lg:mb-16 text-center">
          <div className="mb-3.5 inline-flex items-center gap-2 rounded-full border border-slate-200/90 bg-white px-4 py-1 text-xs font-extrabold text-slate-800 shadow-2xs uppercase tracking-wider">
                ...
                {marqueeItems.map((p, idx) => (
                  ...
                  >
                    ...
                    <img
                      ...
                      loading="lazy"
                      className="relative z-10 max-h-[50px] max-w-[145px] object-contain opacity-85 transition-all duration-300 group-hover:scale-[1.05] group-hover:opacity-100 sm:max-h-[58px] sm:max-w-[170px]"
                    />
                  </div>
                ))}
              </div>
