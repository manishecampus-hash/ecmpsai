            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div
                        ...
                        style={{ background: "linear-gradient(145deg, #fff7f5 0%, #fde8e0 60%, #f9d0c4 100%)" }}
                    >
                        {/* Floating badges */}
                        ...
                        <div className="absolute bottom-0 left-0 right-0 flex justify-center">
                            <svg viewBox="0 0 220 280" className="w-52" xmlns="http://www.w3.org/2000/svg">
                                {/* Rocket body */}
                                <ellipse cx="110" cy="180" rx="28" ry="70" fill="#e05c3a" />
                                <ellipse cx="110" cy="115" rx="28" ry="45" fill="#fff" stroke="#e05c3a" strokeWidth="2" />
                                {/* Nose */}
                                <path d="M82 120 Q110 60 138 120 Z" fill="#e05c3a" />
                                {/* Window */}
                                <circle cx="110" cy="130" r="14" fill="#c8e6fa" stroke="#e05c3a" strokeWidth="2" />
                                {/* Student face */}
                                <circle cx="110" cy="128" r="10" fill="#f5c6a0" />
                                <circle cx="106" cy="126" r="1.5" fill="#333" />
                                <circle cx="114" cy="126" r="1.5" fill="#333" />
                                <path d="M106 132 Q110 136 114 132" stroke="#c0725a" strokeWidth="1.2" fill="none" strokeLinecap="round" />
                                {/* Cap */}
                                <rect x="101" y="116" width="18" height="3" rx="1" fill="#3730a3" />
                                <polygon points="110,108 118,116 102,116" fill="#3730a3" />
                                <line x1="118" y1="116" x2="122" y2="119" stroke="#3730a3" strokeWidth="1.5" />
                                <circle cx="122" cy="120" r="2" fill="#fbbf24" />
                                {/* Wings */}
                                <path d="M82 175 Q60 185 65 210 Q80 200 82 185 Z" fill="#e05c3a" opacity="0.8" />
                                <path d="M138 175 Q160 185 155 210 Q140 200 138 185 Z" fill="#e05c3a" opacity="0.8" />
                                {/* Flames */}
                                <ellipse cx="110" cy="252" rx="12" ry="18" fill="#fbbf24" opacity="0.9" />
                                <ellipse cx="104" cy="256" rx="7" ry="14" fill="#f97316" opacity="0.8" />
                                <ellipse cx="116" cy="256" rx="7" ry="14" fill="#f97316" opacity="0.8" />
                                <ellipse cx="110" cy="260" rx="5" ry="10" fill="#fff" opacity="0.5" />
                                {/* Arms waving */}
                                <path d="M82 165 Q68 155 65 145" stroke="#f5c6a0" strokeWidth="4" strokeLinecap="round" fill="none" />
                                <circle cx="64" cy="143" r="5" fill="#f5c6a0" />
                                <path d="M138 165 Q152 155 155 145" stroke="#f5c6a0" strokeWidth="4" strokeLinecap="round" fill="none" />
                    ...
                    <div className="flex-1 flex flex-col p-8 md:p-10 overflow-y-auto">
                        ...
                        {step === "phone" ? (
                            <form onSubmit={handlePhoneContinue} className="flex flex-col gap-5">
                                {/* Phone row */}
                        ...
                        <p className="mt-6 text-xs text-gray-400 text-center leading-relaxed">
                            ...
                            <a href="/terms" className="text-indigo-500 hover:underline">Terms of Use</a>{" "}
                            &amp;{" "}
