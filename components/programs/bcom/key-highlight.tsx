...
const highlights = [
  {
    ...
    description:
      "One-on-one academic counselling to help you choose the right B.Com specialization and a UGC-recognized university aligned with your career goals.",
    icon: Headphones,
  },
  {
  ...
  },
  {
    title: "Trustworthy",
    description:
      "Honest, transparent, and reliable guidance delivered with professionalism and a strong student-first commitment throughout your journey.",
    icon: ShieldCheck,
  },
  {
    title: "Career Growth",
    description:
      "A structured learning approach focused on building commerce expertise, practical skills, and long-term career advancement.",
    icon: TrendingUp,
  },
];
