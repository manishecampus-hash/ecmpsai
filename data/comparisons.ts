...
export const UNIVERSITY_COMPARISONS: UniversityPair[] = [
    {
        ...
        a: {
            ...
            image: '/compare/amity-vs-mn.png',
            location: 'Noida, UP (Multiple Campuses)',
            established: 2002,
            ...
            description: 'Amity University is a leading private institution known for quality education and industry collaboration.',
        ...
        b: {
            ...
            short: 'MUJ',
            fee: '₹6L - 12L',
            courses: ['Engineering', 'Commerce', 'Arts', 'Science', 'Management', 'Law'],
            image: '/compare/manipal.png',
            location: 'Jaipur, Rajasthan',
            established: 2016,
            ranking: 'NIRF Rank: 142 (Overall)',
            ...
            description: 'Manipal University Jaipur offers quality education with a focus on innovation and skill development.',
    ...
    },
    {
        ...
        a: {
            ...
            affiliations: ['ACBSP Accredited', 'AACSB Member', 'International Quality'],
            highlights: [
            ...
            description: 'Rushford specializes in business education with a focus on management and leadership development.',
        ...
        b: {
            ...
            image: 'https://images.unsplash.com/photo-1516534775068-bb57ad17166b?w=500&h=400&fit=crop',
            ...
            description: 'Chandigarh University Online provides accessible, quality education through flexible online programs.',
    ...
    },
    {
        ...
        a: {
            ...
            description: 'GLA University Online offers cost-effective online education with industry focus.',
        ...
        b: {
            ...
            short: 'AMITY',
            fee: '₹5L - 12L',
            courses: ['MBA', 'M.Tech', 'BCA', 'B.Tech', 'Executive Programs', 'Certification'],
            image: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=500&h=400&fit=crop',
            ...
            description: 'Amity University Online delivers premium education through advanced online learning platforms.',
    ...
    },
    {
        ...
        a: {
            ...
            image: 'https://images.unsplash.com/photo-1441239372925-51cff79fb247?w=500&h=400&fit=crop',
            ...
            description: 'Manipal University is a leading institution known for academic excellence and research.',
        ...
        b: {
            ...
            description: 'Rushford provides world-class business education with global recognition and opportunities.',
            website: 'www.rushforduniversity.edu',
        },
    },
];
...
export function getComparisonByPairId(pairId: string): UniversityPair | undefined {
...
export function searchUniversities(query: string): ComparisonItem[] {
    ...
    return getAllUniversities().filter(
        uni =>
            ...
            uni.courses.some(course => course.toLowerCase().includes(lowercaseQuery))
    );
}

export function filterByFeeRange(min: number, max: number): ComparisonItem[] {
    return getAllUniversities().filter(uni => {
        const fees = uni.fee.split(' - ').map(f => parseInt(f.replace(/₹|L/g, '')));
