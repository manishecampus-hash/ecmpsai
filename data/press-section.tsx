export const pressArticles = [
  {
    ...
    description:
      "eCampus.edu launches AI to help students find the right online degree program in under 60 seconds.",
    headline: "",
  },
  {
    ...
    description:
      "Coverage of eCampus.edu's AI-powered tool for matching students with online degree programs.",
    headline: "",
  },
  {
    name: "ThePrint",
  ...
  },
  {
    ...
    description:
      "India's fastest-growing overseas education consultancy featured for its AI-driven degree matching.",
    headline:
      "Daily Hunt features the story of India's fastest-growing overseas education consultancy...",
  },
];
